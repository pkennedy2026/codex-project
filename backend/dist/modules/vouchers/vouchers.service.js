...
let VouchersService = class VouchersService {
    constructor(vouchers, tenants, plans, subscribers) {
    ...
    async issue(params) {
        ...
        const voucher = this.vouchers.create({
            ...
            plan,
            code,
            validityMinutes: (_a = params.validityMinutes) !== null && _a !== void 0 ? _a : 60,
...
exports.VouchersService = VouchersService = __decorate([
    ...
    __param(3, (0, typeorm_1.InjectRepository)(subscriber_entity_1.Subscriber)),
